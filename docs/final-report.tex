...
We compared RAG-produced CVSS scores against traditional CVSS scoring across three test cases. Values below are illustrative; replace with final benchmark outputs when available. Baseline-only RAG and automated CVSS calculators are not yet scripted in \texttt{src/}, so these comparisons were assembled manually.
